...
install.packages("devtools",repos = "https://cran.ms.unimelb.edu.au/")
devtools::install()
...
2. Simulate mixed background
```{r}
mix_bg <- simulate_mixing(background_sample = bg1,
...
```{r}
clusters <- simulate_clusters(background_sample = bg1,
                  n_clusters = 2,
                  bg_type = "Others",
                  win = NULL,
