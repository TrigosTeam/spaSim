...
```
The simulated image shows a tumour cluster and an immune cluster on a mixed background image. The primary cell type of the tumour cluster is "Tumour", and some "Immune1" and "Others" cells also lie in the tumour cluster. The primary cell type of the immune cluster is "Immune1", and some "Immune2" and "Others" cells also lie in the immune cluster. 
...
The simulated image shows two layers of immune rings. The primary cell type in the inner ring (internal tumour margin) is coloured green, and some "Tumour" cells also lie in the inner ring. The outer ring (external tumour margin) is coloured blue, and some other "Others" cells also lie in the outer ring.
