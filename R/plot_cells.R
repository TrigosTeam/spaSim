...
#'
#' @param sce_object SingleCellExperiment object or data.frame that has cell locations and cell type info -- not sure what these numbers and descriptions mean
